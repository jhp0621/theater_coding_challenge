class OrdersController < ApplicationController
  ...
  def create
    ...
    if @order.save
      ...
      @line_items.each do |i|
        ...
        next unless @order.update(total_amount: @order_total_amount)
  ...
  def order_params
    ...
    params.require(:order).permit(:first_name, :last_name, :email, :credit_card_number, :expiration_month,
                                  :expiration_year, :showtime_id, :adult, :child, :senior)
  end
end
